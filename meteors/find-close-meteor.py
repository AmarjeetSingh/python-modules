...
if __name__ == '__main__':       # useful when you want to use your program for importing as a python module in other words, 
                                 # Don't run script code when imported as a func/module
